...
<html lang="en">
    ...
    <body>
        ...
        <main role="main" class="container">
            ...
            <div id="acceptCallingModal" class="modal fade show" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="acceptCallingModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="acceptCallingModalLabel">Calling .....</h5>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" id="decline" data-dismiss="modal">Cancel</button>
            ...
            <div id="callingModal" class="modal fade show" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="acceptCallingModalLabel">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="callingModalLabel">Calling .....</h5> 
                        </div>
...
<footer class="footer">
    <div class="container">
        <div class="copy">
            &copy; 2013-2020 <strong>ApiRTC</strong> by <a href="//apizee.com" title="Apizee" target="_apizee"><img src="../main/images/apizee_logo.png" alt="Apizee"></a>
        </div>
    </div>
</footer>
<script>
